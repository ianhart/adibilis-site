...
const engineCards = [
  {
    ...
    features: [
      'Up to 8 scanning engines and 700+ rules — not just axe-core',
      ...
      'Multi-engine consensus scoring reduces false positives',
    ],
    footer:
      'Powered by Tirani. Ensemble engine runs IBM, QualWeb, HTML CodeSniffer, Siteimprove Alfa, and more alongside axe-core.',
  },
  {
...
const pricingPlans = [
  ...
  },
  {
    ...
    features: [
      ...
      '4-engine ensemble (380+ rules)',
      'Weekly Tirani scans',
      'AIDA widget included',
    ],
  ...
  },
  {
    ...
    features: [
      'Up to 10 sites, 1,000 pages each',
      '8-engine ensemble (700+ rules)',
      'Daily scans + desktop and mobile',
      'Barrier reports + priority support',
    ],
